// Menu API endpoint for specific restaurant
...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === 'GET') {
      ...
      const { 
        name, description, price, category_id, image_url, available, featured, 
        tags, spice_level, pieces_count, preparation_time, is_vegetarian, 
        is_vegan, is_gluten_free, dynamic_pricing, packaging_price, listing_preference 
      } = req.body;
