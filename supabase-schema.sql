...
-- Function to get order by token (for better performance)
CREATE OR REPLACE FUNCTION get_order_by_token(token_param TEXT)
RETURNS TABLE (
    id INTEGER,
...
BEGIN
    RETURN QUERY
    SELECT 
        o.id, o.order_number, o.order_token, o.customer_name, o.customer_phone, 
        o.customer_email, o.restaurant_id, o.total_amount, o.status, o.order_type,
        o.payment_method, o.special_instructions, o.estimated_preparation_time,
        o.delivery_address, o.delivery_time_estimate, o.delivery_fee,
        o.delivery_latitude, o.delivery_longitude, o.delivery_distance_km,
        o.created_at, o.updated_at, r.name, r.address, r.phone
    FROM orders o
    LEFT JOIN restaurants r ON o.restaurant_id = r.id
    WHERE o.order_token = token_param;
END;
